...
const LoginPage = () => {
    ...
    const loginHeroProps = {
        ...
        imageUrl: "https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?q=80&w=2070&auto=format&fit=crop", // Updated to new Unsplash URL
        altText: "Logistics truck driving on a highway in Cameroon with mountains in background",
        stats: [
            { icon: 'local_shipping', count: t('loginHeroStat1Count', 'authPage'), label: 'loginHeroStat1Label', description: 'loginHeroStat1Description' },
            { icon: 'support_agent', count: t('loginHeroStat2Count', 'authPage'), label: 'loginHeroStat2Label', description: 'loginHeroStat2Description' },
        ],
                ...
                <div className="flex h-full flex-col justify-center px-6 py-12 sm:px-12 xl:px-24">
                    <div className="mx-auto w-full max-w-md flex flex-col gap-8">
                        ...
                        <form action="#" className="flex flex-col gap-5" method="POST" onSubmit={e => e.preventDefault()}>
                            ...
                            <div className="flex items-center justify-between">
                                <label className="flex items-center gap-2 cursor-pointer group">
                                    <input className="w-4 h-4 rounded border-gray-300 text-primary focus:ring-primary dark:border-slate-600 dark:bg-surface-dark" type="checkbox"/>
                                ...
                                <Link className="text-sm font-medium text-primary hover:text-primary-dark transition-colors" href="#">
                                    {t('forgotPassword', 'authPage')}
                                </Link>
                            </div>
                            {/* Login Button */}
                            <button className="flex w-full cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary hover:bg-primary-dark text-white text-base font-bold leading-normal tracking-[0.015em] shadow-sm transition-all active:scale-[0.98]" type="submit">
                        ...
                        <div className="relative flex py-2 items-center">
                            ...
                            <span className="flex-shrink-0 mx-4 text-gray-400 text-xs uppercase">{t('orSeparator', 'authPage')}</span>
                            <div className="flex-grow border-t border-[#cfd9e7] dark:border-slate-700"></div>
                        </div>
                        ...
                        <div className="flex flex-col gap-6">
                            ...
                            <p className="text-center text-sm text-[#4c6c9a] dark:text-slate-400">
                                ...
                                <Link className="text-primary font-semibold hover:text-primary-dark transition-colors ml-1" href={`/${locale}/signup`}>
