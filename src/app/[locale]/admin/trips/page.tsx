...
const STATUSES = ["COMPLETED", "ONGOING", "CANCELLED"] as const;
/* =======================
   Mock data
======================= */
const mockTrips = [
  ...
  ...Array(18)
    ...
    .map((_, i) => ({
      ...
      endDate:
        i % 3 === 0 ? null : `2025-12-${String(20 + (i % 5)).padStart(2, "0")}`,
      endTime:
        i % 3 === 0 ? null : `${String(12 + (i % 6)).padStart(2, "0")}:30`,
    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {[
          ...
          <div
            key={label}
            className="bg-surface border border-border-default rounded-xl p-6 shadow-sm"
          >
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
              ...
              <thead className="text-sm text-text-secondary border-b border-border-default">
                <tr>
                  {[
                    ...
                    <th key={h} className="px-6 py-4 font-medium text-left">
                      {h}
                    </th>
                  ))}
                </tr>
              ...
              <tbody>
                {paginatedTrips.map((trip) => (
                  ...
                  >
                    ...
                    <td className="px-6 py-4">
                      <span
                        className={`px-3 py-1 rounded-full text-xs font-semibold ${getStatusClasses(trip.status)}`}
                      >
                        {trip.status}
                      </span>
                    </td>
        ...
        <div className="bg-surface border border-border-default rounded-xl p-6 shadow-sm">
          ...
          <div
            className="h-96 rounded-lg border border-border-default bg-background-secondary
